...
module.exports = {
  user          : process.env.NODE_ORACLEDB_USER || "pharma",
  ...
  // needed.
  password      : process.env.NODE_ORACLEDB_PASSWORD || "pharma",

  // For information on connection strings see:
  // https://oracle.github.io/node-oracledb/doc/api.html#connectionstrings
  connectString : process.env.NODE_ORACLEDB_CONNECTIONSTRING || "LAPTOP-21RC5VEQ:1521/XE",
